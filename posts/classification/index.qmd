...
# Hyperparameter tuning for the Decision Tree using RandomizedSearchCV
random_search_dt = RandomizedSearchCV(DecisionTreeClassifier(), dt_param_grid, n_iter=10, cv=5, random_state=42)
...
random_search_rf = RandomizedSearchCV(RandomForestClassifier(), rf_param_grid, n_iter=10, cv=5, n_jobs=-1, random_state=42)
...
random_search_svm = RandomizedSearchCV(SVC(), svm_param_grid, n_iter=10, cv=5, n_jobs=-1, random_state=42)
random_search_svm.fit(train_data.drop(['Class'], axis=1), train_data['Class'])
...
# Initialize the RandomizedSearchCV object for Neural Network
random_search_nn = RandomizedSearchCV(MLPClassifier(), nn_param_grid, n_iter=10, cv=5, n_jobs=-1, random_state=42)
random_search_nn.fit(train_data.drop(['Class'], axis=1), train_data['Class'])
